...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibmR0dXllbjE3NyIsImEiOiJjbDY4MThrbnowam02M2tvOWpsbTl1Mjl3In0.w-PeJCrVQSeC9s3iYVKBuQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/ndtuyen177/cl681fxdr001d15ru0gpspbq5',
    scrollZoom: false // center: [-118.11, 34.11],
    // zoom: 6,
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', "".concat(type.toUpperCase(), " Updated Successful"));
              window.setTimeout(function () {
...
},{"./alert":"alert.js","axios":"../../node_modules/axios/index.js"}],"stripe.js":[function(require,module,exports) {
"use strict";
...
var stripe = Stripe('pk_test_51LRs4LE5OLTv5bir0g5OWWDMBQ0gH2ERMqDP6bOmYhc5B5ODYoz9uowW7NFjgbcIzULWKjBkYhNDUvgLwSfnp56m00q8PZ3jVb');
